...
int main(int argc, const char** argv)
{
    try
    {
        ...
        std::string xmlFileName = (boost::filesystem::path(wingstall_root) / boost::filesystem::path("unicode") / boost::filesystem::path("ucd.all.flat.xml")).generic_string();
        ...
        CharacterTable::Instance().WriteDeflate();
